...
public class Exam08 {
	...
	public static void main(String[] args) {
		 ...
		 *     2. 사용자로 부터 1 ~ 5 사이의 정수를 입력 받는다.
		 *     3. 1 번에서 생성한 배열의 길이와 2 번에서 입력한 정수의 값을
		 *        사용하여 2차 배열을 생성한다.
		 *     4. 2 차 배열에 저장할 값을 사용자 입력을 통해 받는다.
		 *        국어 점수 입력 : 60
		 *        영어 점수 입력 : 70
		 *        수학 점수 입력 : 80
		 *     5. 2 차 배열에 저장된 값을 출력하여 확인 한다.
		 *         국어        영어        수학        평균        총점
		 *         60		  70		 80          70.00     210
		 *         60         75         82          72.33     217
		 *         ...        ...        ...         ...       ...
		...
		for(int i = 0; i < arr.length; i++) {
			...
			// 동적 배열 활용하여 총점이 배열에 추가 될 수 있게 하세요.
